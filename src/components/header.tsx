      ...
      >
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-2 px-4 py-3 sm:gap-4 md:py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href={TEL_HREF}
              className="hidden items-center justify-center rounded-full bg-emerald-700 px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-emerald-800 md:inline-flex md:text-sm"
            >
              Позвонить
            </a>
            <button
          ...
          <div className="border-t border-slate-100 px-4 pt-2 pb-1">
            <div className="flex justify-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-700 text-white shadow-sm transition hover:bg-emerald-800"
            ...
            {callbackOpen && (
              ...
              >
                ...
                <button
                  ...
                  className="flex h-11 min-h-[44px] w-full items-center justify-center rounded-lg bg-emerald-700 text-[12px] font-semibold text-white shadow-sm transition hover:bg-emerald-800 disabled:opacity-70"
                >
